...
"""
a = 'Οнищенкο Даниил Αлекϲандрοвич'
""" Задание №1
...
print('№1 ' + str(fio == ['Οнищенкο', 'Даниил', 'Αлекϲандрοвич']))
...
res = list()
for i in enumerate(list('Онищенко')):
    res.append(tuple(i))
print(res)
